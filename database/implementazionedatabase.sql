...
('10','Altoparlanti','129','Edifier','R1280DB','..','Set di altoparlanti 2.0 di alta qualità e potenza dal suono impressionante, inclusi di telecomando a raggi infrarossi'),
('11','Altoparlanti','34','Logitech','Z200','..','Controlli frontali di volume e accensione rendono queste casse una fusione unica tra semplicità e praticabilità. Compatibili con PC, smartphone, tablet e mp3. Alimentatore integrato'),
('12','Altoparlanti','20','AUDIOCORE','AC860','..','Altoparlanti di piccole dimensioni ed economici adatti da posizionare nella scrivania e da portare in viaggio. Possono essere collegati semplicemente tramite cavo USB o jack.'),
...
('16','Per Cuffie','15','Kwmobile','..','..','I cuscinetti per cuffie Bose Soundlink Around-Ear Wireless II sono realizzati in ecopelle resistente, e grazie alla morbida imbottitura in schiuma offrono il massimo comfort di ascolto.'),
('17','Per Cuffie','7','Avantree','ADAD-TR302', '..', 'Divertitevi a condividere canzoni e film con i vostri amici, senza disturbare altri, utilizzando questo duplicatore a Y da 3.5mm con il vostro telefono o tablet o MP3 con due paia di cuffie.'),
('18','Per Cuffie','15','Moretek','..','..', 'Custodia Portatile Case per Airpods, protettiva in silicone dalle linee moderne con inclusi diversi ganci utili per vivere ogni momento della tua vita.'),
('19','Per Casse','7','deleyCON','MK3331','..','Cavo deleyCON 2x 1,5mm² - 48x0,20mm (treccia) in alluminio rivestito in rame compatibile con altoparlanti e casse. Marcatura della polarità (nero/rosso).'),
('20','Per Casse','34','Duronic','SPS1022','..','Due piedistalli per casse acustiche, base di appoggio 12*12. Il prodotto ha una altezza di 40cm per permettervi di posizionare le vostre casse ad un altezza ottimale.'),
('21','Per Casse','10','Khanka','UK-T-JBL-02','..','Custodia per casse bluetooth JBL, pratica e imbottita per mantenere la propria cassa e gli accessori sicuri, protetti e organizzati');
>>>>>>> 94237360d3d31813a1324777ecd3dbc2c08cbbb6
